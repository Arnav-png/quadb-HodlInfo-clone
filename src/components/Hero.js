                ...
                <table className="table table-borderless text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            </a></td><td className="align-middle"><h4 class="table-text">₹ 1,79,500</h4></td>
                        ...
                        <tr><td className="align-middle"><h4 className="table-text">2</h4></td>
                            ...
                            <td className="align-middle"><h4 classNamen="table-text">₹ 1,76,875</h4></td>
                        ...
                        <tr>
                            ...
                            <td className="align-middle"><a target="_blank" href=""><h4 className="table-text">
                                <img src="zebpay.png" className="exchange-logo" /><span class="exchange-name">Zebpay</span></h4></a></td>
